...
///============================================================================================
    ...
    public function write_skype_options($graph_data, $n, $location, $filename){
    
        $general_options = $this->general_options();
        $main_chart_options = $this->skype_chart_options($graph_data, $n);   
    ...
    public function skype_chart_options($graph_data, $n){
        $chart["renderTo"] = "'graph'";
        $chart["marginTop"] = "40";
        $chart["marginRight"] = "0";
        $chart["marginBottom"] = "0";
        $rangeSelector["enabled"] = "false";
        $title["text"] = "'Skype messages over time'";
        $xAxis["maxZoom"] = "2 // fourteen days";
        $yAxis["title"] = array("text" => "'Weekly Message Volume'");
        $legend["layout"] = "'horizontal'";
        $legend["align"] = "'top'";
...
//====================================================================
    ...
    public function write_msn_options($graph_data, $n, $location, $filename){
    
        $general_options = $this->general_options();
        $main_chart_options = $this->msn_chart_options($graph_data, $n);   
        $pie_chart_options = $this->pie_chart_options($graph_data, $n);
    ...
    public function msn_chart_options($graph_data, $n){
        $chart["renderTo"] = "'graph'";
        $chart["marginTop"] = "40";
        $chart["marginRight"] = "0";
        $chart["marginBottom"] = "0";
        $rangeSelector["enabled"] = "false";
        $title["text"] = "'MSN messages over time'";
        $xAxis["maxZoom"] = "2 // fourteen days";
        $yAxis["title"] = array("text" => "'Weekly Message Volume'");
        $legend["layout"] = "'horizontal'";
        $legend["align"] = "'top'";
...
public function write_facebook_options($graph_data, $n, $location, $filename){

    $general_options = $this->general_options();
    $main_chart_options = $this->facebook_chart_options($graph_data, $n);   
    $pie_chart_options = $this->pie_chart_options($graph_data, $n);
...
public function facebook_chart_options($graph_data, $n){
    $chart["renderTo"] = "'graph'";
    $chart["marginTop"] = "40";
    $chart["marginRight"] = "0";
    $chart["marginBottom"] = "0";
    $rangeSelector["enabled"] = "false";
    $title["text"] = "'Facebook Messages over time'";
    $xAxis["maxZoom"] = "2 // fourteen days";
    $yAxis["title"] = array("text" => "'Weekly Message Volume'");
    $legend["layout"] = "'horizontal'";
    $legend["align"] = "'top'";
